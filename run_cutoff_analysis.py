...
def main():
    ...
    # --- MODIFIED: Define the fixed scope ---
    ...
    for original_run_dir in original_run_dirs:
        ...
        # Load the specific config for this run to know which DR method was used
        ...
        # --- REFACTORED LOGIC to handle different strategies ---
        
        strategies_to_check = []
        # Check if a PROJECTION run exists
        ...
        # Check if a CO-EMBEDDING run exists
        ...
        for strategy in strategies_to_check:
            for cutoff in affinity_cutoffs:
                ...
                if strategy == "Projection":
                    ...
                    if dr_method_key == 'tsne': # t-SNE doesn't have the -Coembed suffix in its dir
                        output_dir_leaf = dr_params['short_name'].replace('-', '_')
                    ...
                    cmd.append("--simspace_csv_path", os.path.abspath(simspace_path))
