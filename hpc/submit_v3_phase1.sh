#!/bin/bash
# =============================================================================
# UMMBAS v3.0 - Phase 1 Job Submission Script
# =============================================================================
# Phase 1: Hyperparameter Sweep & Dimensionality Testing
# - Target: TyrosineProteinKinaseABL1 (Tyro)
# - Dimensions: 2D, 5D, 10D
# - Representations: features (PCA + UMAP), fingerprints (PCA + UMAP-Jaccard)
# - Total: 260 runs (52 configs × 5 seeds)
# =============================================================================
...
echo "============================================================"
echo "UMMBAS v3.0 - Phase 1 Submission"
echo "============================================================"
...
echo "Total Jobs: ${TOTAL_JOBS} (expected: 260)"
echo "============================================================"
...
for config_file in "${CONFIG_DIR}"/*.json; do
    for seed in "${RANDOM_SEEDS[@]}"; do
        ...
        job_name="UMMBAS_v3_phase1_${config_basename}_s${seed}"
...
echo "  python extract_phase1_best_configs.py"
echo "============================================================"
