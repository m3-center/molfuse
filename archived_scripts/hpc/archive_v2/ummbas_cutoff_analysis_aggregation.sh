...
JOB_NAME="UMMBAS_Cutoff_Analysis"
...
SCRIPT_DIR=$(pwd) 
ORCHESTRATOR_SCRIPT="${SCRIPT_DIR}/aggregate_cutoff_analysis.py"
...
echo "Starting aggregate_cutoff_analysis.py..."

mkdir -p final_report_cutoff_analysis
